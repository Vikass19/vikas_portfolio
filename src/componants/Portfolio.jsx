...
const Portfolio = () => {
  return (
    <section className="bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white py-20 px-6" id="portfolio">
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
        {/* Blog Project Card */}
        <div className="relative group rounded-xl shadow-xl overflow-hidden bg-gray-800 transform hover:scale-105 hover:shadow-2xl transition duration-500">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black opacity-0 group-hover:opacity-100 transition duration-700">
            <div className="flex flex-col justify-end h-full p-6 space-y-4">
              <h3 className="text-3xl font-semibold text-teal-400">Blog Project</h3>
        ...
        <div className="relative group rounded-xl shadow-xl overflow-hidden bg-gray-800 transform hover:scale-105 hover:shadow-2xl transition duration-500">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black opacity-0 group-hover:opacity-100 transition duration-700">
            <div className="flex flex-col justify-end h-full p-6 space-y-4">
              <h3 className="text-3xl font-semibold text-teal-400">Recipe Project</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
      ...
      <div className="mt-16 text-center" data-aos="fade-up">
        ...
        <a
          href="#contact"
          className="mt-6 inline-block px-6 py-3 bg-teal-500 text-black rounded-full font-bold text-lg hover:bg-teal-600 transition shadow-lg"
        >
          Contact Me
        </a>
      </div>
