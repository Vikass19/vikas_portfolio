  ...
  const projects = [
    {
      ...
      desc: "A responsive art gallery website built with React and Tailwind CSS for showcasing artwork through clean layouts, responsive design and an easy-to-navigate user experience.",
      stack: ["React", "Tailwind CSS"],
      github: "https://github.com/Vikass19/web_art_gallery",
      live: "https://www.tanvinayak.com/",
    },
    {
      title: "Blog Platform",
      slug: "blog-platform",
      images: [blog1, blog2, blog3],
      desc: "A full-stack blog platform with user authentication, Markdown support and complete CRUD functionality, built with React, Node.js and MongoDB.",
    ...
    },
    {
      ...
      desc: "A recipe sharing web application with more than 12,000 recipes, smart search and recipe management features using Django REST Framework and React.",
    ...
    },
    {
      ...
      desc: "A full-stack college management system with role-based authentication, attendance tracking, marks management and notice board functionality.",
      stack: ["MERN", "JWT"],
    ...
    },
    {
      ...
      desc: "A React web application using the GitHub API to search developer profiles, explore repositories and display GitHub account information.",
    ...
    <section id="portfolio" className="py-16 sm:py-20">
      ...
      <div className="mb-12">
        ...
        <p className="font-display text-muted max-w-xl">
          Selected web development projects built with React, JavaScript,
          Python, Django, Node.js and modern web technologies.
        </p>
      </div>
