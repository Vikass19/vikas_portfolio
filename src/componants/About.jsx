...
const About = () => {
  return (
    <section
      id="about"
      className="bg-gradient-to-br from-black to-gray-900 text-gold px-4 sm:px-6 lg:px-20 py-16 sm:py-20 rounded-lg transition-all duration-700 ease-in-out"
    >
      {/* Section Header */}
      <div className="text-center mb-12" data-aos="fade-down">
        <h2 className="text-3xl sm:text-4xl font-extrabold mb-4 hover:text-yellow transition duration-300">
          About <span className="text-yellow">Me</span>
        </h2>
        <p className="text-base sm:text-lg max-w-2xl mx-auto text-gray-400 hover:text-yellow transition duration-300">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 flex justify-center" data-aos="fade-right">
          <div className="relative group">
            <img
              src={profile_image}
              alt="vikas-profile"
              className="rounded-full w-40 h-40 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 object-cover shadow-xl border-4 border-gray-600 group-hover:scale-105 group-hover:rotate-1 transition-all duration-700 ease-in-out"
            />
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-4" data-aos="fade-left">
          <h3 className="text-2xl sm:text-3xl font-bold text-gray-300 hover:text-yellow transition duration-300">
